...
const cityData: Record<string, string[]> = {
  Nabeul: [
    'Nabeul', 'Hammamet', 'K├®libia', 'Dar Cha├óbane El Fehri', 'B├®ni Khiar',
    'El Mida', 'Hammam Ghez├¿ze', 'Korba', 'Menzel Bouzelfa', 'Menzel Temime',
    'Soliman', 'Takilsa', 'Grombalia', 'B├®ni Khalled', 'Bou Argoub', 'El Haouaria',
  ],
  Ariana: ['Ariana', 'Soukra', 'Raoued', 'Kalaat el-Andalous', 'Sidi Thabet', 'Mnihla', 'Ettadhamen'],
  Tunis: ['Tunis', 'La Marsa', 'Le Kram', 'La Goulette', 'Carthage', 'Sidi Bou Sa├»d', 'Gammarth', 'Sidi Hassine', 'El Ouardia'],
  Sousse: ['Sousse', 'Hammam Sousse', 'Akouda', 'Kal├óa Kebira', 'Kal├óa Seghira', 'Msaken', 'Enfidha', 'Bouficha', 'Hergla'],
  'Ben Arous': ['Ben Arous', 'Ezzahra', 'Hammam Lif', 'Hammam Chott', 'Bou Mhel el-Bassatine', 'Mornag', 'Rad├¿s', 'M├®grin', 'Fouchana'],
  ...
  Monastir: ['Monastir', 'Khniss', 'Ouerdanin', 'Sahline', 'Z├®ramdine', 'B├®ni Hassen', 'Jemmal', 'Bekalta', 'Sayada', 'T├®boulba', 'Ksibet el-M├®diouni'],
  Beja: ['B├®ja Centre', 'Amdoun', 'Goubellat', 'Medjez el-Bab', 'Nefza', 'T├®boursouk', 'Testour', 'Thibar'],
  Gabes: ['Gab├¿s Centre', 'El Hamma', 'Ghannouch', 'Mareth', 'Matmata', 'Menzel El Habib', 'M├®touia'],
  Gafsa: ['Gafsa Centre', 'El Guettar', 'El Ksar', 'Mdhilla', 'M├®tlaoui', 'Moular├¿s', 'Redeyef', 'Sened'],
  Jendouba: ['Jendouba Centre', 'A├»n Draham', 'Balta-Bou Aouane', 'Bou Salem', 'Fernana', 'Ghardimaou', 'Oued Meliz', 'Tabarka'],
  Kairouan: ['Kairouan Centre', 'Bou Hajla', 'Chebika', 'Echrarda', 'Haffouz', 'Hajeb El Ayoun', 'Nasrallah', 'Oueslatia', 'Sbikha'],
  Kasserine: ['Kasserine Centre', 'F├®riana', 'Foussana', 'Haidra', 'Jedelienne', 'Majel Bel Abb├¿s', 'Sbe├»tla', 'Sbiba', 'Thala'],
  Kebili: ['K├®bili Centre', 'Douz Centre', 'Faouar', 'Souk Lahad'],
  Kef: ['Le Kef Centre', 'Dahmani', 'Jerissa', 'Kal├óat Khasba', 'Kalaat Senan', 'Nebeur', 'Sakiet Sidi Youssef', 'Tajerouine'],
  Mahdia: ['Mahdia Centre', 'Bou Merdes', 'Chebba', 'Chorbane', 'El Jem', 'Hebira', 'Ksour Essef', 'Melloul├¿che', 'Ouled Chamekh', 'Sidi Alouane'],
  Manouba: ['La Manouba Centre', 'Borj El Amri', 'Djedeida', 'Douar Hicher', 'El Battan', 'Mornaguia', 'Oued Ellil', 'Tebourba'],
  Medenine: ['M├®denine Centre', 'Ben Guerdane', 'Djerba Ajim', 'Djerba Houmt Souk', 'Djerba Midoun', 'Zarzis'],
  'Sidi Bouzid': ['Sidi Bouzid Centre', 'Bir El Hafey', 'Cebbala Ouled Asker', 'Jilma', 'Mazzouna', 'Menzel Bouzaiane', 'Regueb', 'Sidi Ali Ben Aoun'],
  Siliana: ['Siliana Centre', 'Bou Arada', 'Bargou', 'Ga├ófour', 'Kesra', 'Makthar', 'Rouhia'],
  Tataouine: ['Tataouine Centre', 'Bir Lahmar', 'Dehiba', 'Ghomrassen', 'Remada', 'Sm├ór'],
...
/* ÔöÇÔöÇ Documents section ÔöÇÔöÇ */
.sg-doc-section {
  background: #f2f3fd;
  border-radius: 16px;
  padding: 24px 28px;
  ...
  return (
    <div className="sg-root">
      ...
      <nav className="sg-nav">
        <a className="sg-nav-brand" href="/">
          <img
            ...
            src={logo}
            alt="Ville de K├®libia"
          />
          <span className="sg-nav-name">Ville de K├®libia</span>
        </a>
        ...
        <div className="sg-layout">
          ...
          <div className="sg-sidebar">
            ...
            <p className="sg-hero-sub">
              Rejoignez l'├®cosyst├¿me Smart City de K├®libia. Acc├®dez ├á vos
              services municipaux, suivez vos demandes et participez ├á la vie
              locale en un clic.
            </p>
            <div className="sg-glass-tile">
              ...
              <div>
                <div className="sg-tile-title">S├®curit├® des donn├®es</div>
                <div className="sg-tile-body">
                  Vos documents sont chiffr├®s et stock├®s localement selon les
                  normes nationales.
                </div>
              </div>
            </div>
            <div className="sg-hero-img">
              <img
                ...
                alt="K├®libia Fortress"
              />
              <div className="sg-hero-img-caption">K├®libia : Entre Histoire et Futur</div>
            </div>
          </div>
          ...
          <div className="sg-card">
            <form onSubmit={onSubmit}>
              ...
              {/* ÔöÇÔöÇ Section 1: Identit├® ÔöÇÔöÇ */}
              <div className="sg-section-hd">
                <h2 className="sg-section-title">
                  Identit├® Personnelle
                  <span className="sg-section-title-ar">Ïº┘ä┘ç┘ê┘èÏ® Ïº┘äÏ┤Ï«ÏÁ┘èÏ®</span>
                </h2>
                <span className="sg-step-badge">Etape 01/04</span>
              </div>
              <div className="sg-grid-2">
                <div className="sg-field">
                  <label className="sg-label">Pr├®nom / Ïº┘äÏÑÏ│┘à</label>
                ...
                <div className="sg-field">
                  <label className="sg-label">Nom / Ïº┘ä┘ä┘éÏ¿</label>
                  <input className="sg-input" type="text" placeholder="Ex: Ben Ali" required value={lastName} onChange={e => setLastName(e.target.value)} />
                </div>
                <div className="sg-field">
                  <label className="sg-label">N┬░ Carte d'Identit├® (CIN) / Ï▒┘é┘à Ï¿ÏÀÏº┘éÏ® Ïº┘äÏ¬Ï╣Ï▒┘è┘ü</label>
                ...
                <div className="sg-field">
                  <label className="sg-label">Date de Naissance / Ï¬ÏºÏ▒┘èÏ« Ïº┘ä┘ê┘äÏºÏ»Ï®</label>
                ...
                <div className="sg-field sg-grid-full">
                  <label className="sg-label">Lieu de Naissance / ┘à┘âÏº┘å Ïº┘ä┘ê┘äÏºÏ»Ï®</label>
                  <input className="sg-input" type="text" placeholder="Ex: K├®libia" required value={placeOfBirth} onChange={e => setPlaceOfBirth(e.target.value)} />
                </div>
              </div>
              ...
              {/* ÔöÇÔöÇ Section 2: Documents ÔöÇÔöÇ */}
              <div className="sg-doc-section">
                <div className="sg-section-hd" style={{ marginBottom: 0 }}>
                  <h2 className="sg-section-title">
                    Documents
                    <span className="sg-section-title-ar">Ïº┘ä┘êÏ½ÏºÏª┘é Ïº┘ä┘àÏÀ┘ä┘êÏ¿Ï®</span>
                  </h2>
                      ...
                      <div className="sg-cin-slot">
                        {(side === 'front' ? cinFront : cinBack) ? (
                          ...
                          <>
                            ...
                            <span className="sg-cin-slot-lbl">{side === 'front' ? 'Face Avant CIN' : 'Face Arri├¿re CIN'}</span>
                            <span className="sg-cin-slot-sub">{side === 'front' ? 'Recto / ┘êÏ¼┘ç Ïº┘äÏ¿ÏÀÏº┘éÏ®' : 'Verso / Ï©┘çÏ▒ Ïº┘äÏ¿ÏÀÏº┘éÏ®'}</span>
                          </>
                        )}
                      </div>
              ...
              {/* ÔöÇÔöÇ Section 3: Contact & Localisation ÔöÇÔöÇ */}
              <div className="sg-section-hd">
                <h2 className="sg-section-title">
                  Contact &amp; Localisation
                  <span className="sg-section-title-ar">Ïº┘äÏºÏ¬ÏÁÏº┘ä ┘êÏº┘ä┘à┘ê┘éÏ╣</span>
                </h2>
                <span className="sg-step-badge">Etape 03/04</span>
              </div>
              <div className="sg-grid-2">
                <div className="sg-field">
                  <label className="sg-label">Mobile / Ïº┘ä┘çÏºÏ¬┘ü Ïº┘äÏ¼┘êÏº┘ä</label>
                ...
                <div className="sg-field">
                  <label className="sg-label">E-mail / Ïº┘äÏ¿Ï▒┘èÏ» Ïº┘äÏÑ┘ä┘âÏ¬Ï▒┘ê┘å┘è</label>
                  <input className="sg-input" type="email" placeholder="nom@exemple.com" required value={email} onChange={e => setEmail(e.target.value)} />
                </div>
                <div className="sg-field">
                  <label className="sg-label">Gouvernorat / Ïº┘ä┘ê┘äÏº┘èÏ®</label>
                ...
                <div className="sg-field">
                  <label className="sg-label">Ville / Ïº┘ä┘àÏ╣Ï¬┘àÏ»┘èÏ®</label>
                ...
                <div className="sg-field sg-grid-full">
                  <label className="sg-label">Adresse R├®sidence / Ïº┘äÏ╣┘å┘êÏº┘å Ïº┘äÏ│┘â┘å┘è</label>
              ...
              {/* ÔöÇÔöÇ Section 4: S├®curit├® ÔöÇÔöÇ */}
              <div className="sg-section-hd">
                <h2 className="sg-section-title">
                  S├®curit├®
                  <span className="sg-section-title-ar">Ïº┘äÏú┘àÏº┘å</span>
                </h2>
                <span className="sg-step-badge">Etape 04/04</span>
              </div>
              <div className="sg-grid-2">
                <div className="sg-field">
                  <label className="sg-label">Mot de passe / ┘â┘ä┘àÏ® Ïº┘äÏ│Ï▒</label>
                  <div className="sg-input-wrap">
                    <input className="sg-input" type={showPassword ? 'text' : 'password'} placeholder="ÔÇóÔÇóÔÇóÔÇóÔÇóÔÇóÔÇóÔÇóÔÇóÔÇó" required value={password} onChange={e => setPassword(e.target.value)} />
                ...
                <div className="sg-field">
                  <label className="sg-label">Confirmer / Ï¬Ïú┘â┘èÏ» ┘â┘ä┘àÏ® Ïº┘äÏ│Ï▒</label>
                  <div className="sg-input-wrap">
                    <input className="sg-input" type={showPassword ? 'text' : 'password'} placeholder="ÔÇóÔÇóÔÇóÔÇóÔÇóÔÇóÔÇóÔÇóÔÇóÔÇó" required value={rePassword} onChange={e => setRePassword(e.target.value)} />
                    <button type="button" className="sg-eye" onClick={() => setShowPassword(p => !p)}>
                      <i className={`fas ${showPassword ? 'fa-eye-slash' : 'fa-eye'}`}></i>
                    </button>
                  </div>
              ...
              <div className="sg-actions" style={{ marginTop: 32 }}>
                <div className="sg-submit-row">
                  ...
                  <p className="sg-login-link">
                    D├®j├á inscrit ? <Link to="/login">Se connecter</Link>
                  </p>
                </div>
                <div className="sg-terms-row">
                  <input type="checkbox" checked={termsAccepted} onChange={e => setTermsAccepted(e.target.checked)} />
                  <span className="sg-terms-text">
                    J'accepte les <a href="#">Conditions G├®n├®rales d'Utilisation</a> et la politique de protection des donn├®es personnelles de la Commune de K├®libia.
                  </span>
                </div>
              </div>
      ...
      <footer className="sg-footer">
        <div>
          <div className="sg-footer-brand">Ville de K├®libia</div>
          <div className="sg-footer-copy">┬® 2024 Commune de K├®libia ÔÇö Smart City Portal</div>
        </div>
        ...
        <div className="sg-cam-overlay">
          <div className="sg-cam-modal">
            <div className="sg-cam-header">
              <span className="sg-cam-title">{t('capture_title')} ÔÇö {showCamera === 'front' ? 'Face Avant' : 'Face Arri├¿re'}</span>
