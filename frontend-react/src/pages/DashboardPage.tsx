...
.db-section-title::before {
  ...
  background:linear-gradient(135deg, #b8936a 0%, #d5b599 100%); border-radius:3px; flex-shrink:0;
}
.db-action-card {
...
.db-action-icon {
  ...
  background:rgba(213,181,153,.08); display:flex; align-items:center;
  justify-content:center; margin-bottom:8px; transition:transform .2s;
  color:#d5b599; font-size:1rem;
}
...
.db-profile-avatar {
  ...
  overflow:hidden; border:2px solid rgba(213,181,153,.18);
}
.db-profile-avatar-inner {
  width:100%; height:100%; display:flex; align-items:center; justify-content:center;
  font-size:1.4rem; font-weight:800; color:#d5b599; background:#fef2f2;
}
.db-stat-row {
...
.db-stat-badge {
  background:rgba(213,181,153,.1); color:#d5b599;
  font-weight:800; padding:2px 8px; border-radius:3px; font-size:.78rem;
}
.db-signalement-btn {
  width:100%; padding:16px; background:linear-gradient(135deg, #b8936a 0%, #d5b599 100%); color:#fff;
...
.db-news-item:hover .db-news-headline { color:#d5b599; }
.db-news-time { font-size:.68rem; font-weight:700; color:#d5b599; display:block; margin-bottom:3px; }
...
.db-urgence { background:linear-gradient(135deg, #b8936a 0%, #d5b599 100%); padding:28px; color:#fff; }
...
.db-rec-icon { width:44px; height:44px; border-radius:50%; background:rgba(213,181,153,.08); display:flex; align-items:center; justify-content:center; color:#d5b599; flex-shrink:0; }
...
.db-footer-brand { font-size:1.05rem; font-weight:900; color:#d5b599; text-transform:uppercase; letter-spacing:-.3px; font-family:'Public Sans',sans-serif; }
...
.db-footer-link:hover { color:#d5b599; }
...
.db-footer-social-btn:hover { background:linear-gradient(135deg, #b8936a 0%, #d5b599 100%); color:#fff; }
...
.db-footer-legal a:hover { color:#d5b599; }
  ...
  const rightSidebar = (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16, paddingTop: 8 }}>
      ...
      <div style={{ background: '#fff', padding: '24px' }}>
        <div style={{ fontWeight: 800, fontSize: '.82rem', color: '#1a1c1c', textTransform: 'uppercase', letterSpacing: '.5px', paddingBottom: 6, borderBottom: '2px solid #d5b599', display: 'inline-block', marginBottom: 16, fontFamily: 'Public Sans,sans-serif' }}>
          {t('news_title')}
        </div>
        ...
        <Link
          to="/news"
          style={{ display: 'inline-flex', alignItems: 'center', gap: 6, marginTop: 20, fontSize: '.72rem', fontWeight: 800, color: '#d5b599', textDecoration: 'none', textTransform: 'uppercase', borderBottom: '2px solid rgba(213,181,153,.2)', paddingBottom: 2 }}
        >
      ...
      <div style={{ background: '#fff', border: '1px solid #eeeeee', marginBottom: 28 }}>
        <div style={{ padding: '14px 18px', borderBottom: '1px solid #eeeeee', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <Link
            ...
            style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 18px', background: 'linear-gradient(135deg, #b8936a 0%, #d5b599 100%)', color: '#fff', fontWeight: 700, fontSize: '.78rem', textDecoration: 'none', textTransform: 'uppercase', letterSpacing: '.5px' }}
          >
            <i className="fas fa-plus-circle"></i>
            {t('new_signalement')}
          </Link>
        ...
        <div style={{ padding: '12px 16px', display: 'flex', flexDirection: 'column', gap: 8 }}>
          ...
          {reclamations.length > 3 && (
            <Link to="/mes-reclamations" style={{ textAlign: 'center', display: 'block', fontSize: '.78rem', fontWeight: 700, color: '#d5b599', textDecoration: 'none', padding: '10px 0' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          ...
          <div>
            <div style={{ fontWeight: 800, color: '#1a1c1c', fontFamily: 'Public Sans,sans-serif' }}>
              {t('forum')}
              {forumUnread > 0 && (
                <span style={{ marginLeft: 8, background: '#d5b599', color: '#fff', fontSize: '.62rem', fontWeight: 800, padding: '1px 7px', borderRadius: 999 }}>{forumUnread}</span>
              )}
            </div>
        ...
        <div className="db-footer-grid">
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 14 }}>
              <i className="fas fa-landmark" style={{ color: '#d5b599', fontSize: '1.1rem' }}></i>
