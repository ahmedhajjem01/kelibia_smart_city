...
export default function AgentDashboardPage() {
  ...
  useEffect(() => {
    ...
    // GeoJSON coords are [lng, lat]; Leaflet L.polygon uses [lat, lng] — convert:
    ...
    // Don't add to map yet — controlled by toggle button
  ...
  // TEMP: toggle mask layer when showMask changes — delete after report screenshots
  useEffect(() => {
