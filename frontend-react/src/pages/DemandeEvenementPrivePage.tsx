...
const PRIVATE_TYPE_OPTIONS = [
  { value: 'mariage',         label: '💍 Mariage / زفاف' },
  { value: 'fete_familiale',  label: '🎂 Fête familiale / احتفال عائلي' },
  { value: 'remise_diplomes', label: '🎓 Remise de diplômes / تسليم الشهادات' },
]

const LIEU_OPTIONS = [
  { value: 'salle_fetes',    label: 'Salle des fêtes / قاعة الأفراح' },
  { value: 'domicile_prive', label: 'Domicile privé / المنزل الخاص' },
...
const GPS_CONFIG: Record<GpsStatus, { color: string; bg: string; icon: string; text: string }> = {
  ...
  manual:  { color: '#198754', bg: '#d1e7dd', icon: 'fa-map-pin',              text: 'Position sur la carte' },
              ...
              <div className="card-body p-4 p-md-5 bg-white">
                {success ? (
                  <div className="text-center py-5">
                    ...
                    <h3 className="fw-bold mb-2">Déclaration envoyée !</h3>
                    <p className="text-muted">Votre déclaration d'événement privé a été reçue par la municipalité.</p>
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-5">
                      ...
                      <div className="row g-3">
                        ...
                        <div className="col-md-6">
                          <label className={lc}>
                            {lang === 'ar' ? 'عنوان الفعالية' : "Intitulé / Nom de l'événement"} <span className="text-danger">*</span>
                          </label>
                    ...
                    <div className="mb-5">
                      ...
                      <div className="mt-4">
                        ...
                        <div className="rounded-4 overflow-hidden shadow-sm" style={{ height: 280, border: '2px solid #dee2e6' }}>
                    ...
                    <div className="mb-5">
                      <div className="d-flex align-items-center gap-2 mb-4 pb-2 border-bottom">
                        ...
                        <h5 className="fw-bold mb-0">
                          {lang === 'ar' ? 'معلومات المُعلِّن' : 'Informations sur le déclarant'}
                        </h5>
                      </div>
                      <div className="row g-3">
                        <div className="col-md-6">
                    ...
                    <div className="mb-5">
                      ...
                      <div className="alert border-0 rounded-3 mb-4 d-flex gap-2"
                        ...
                        <span>
                          <strong>Événement privé :</strong> Seule la copie de votre CIN est obligatoire.
                          {eventTypeLabel.includes('Mariage') && ' Pour un mariage, vous pouvez aussi joindre le contrat de location de salle si disponible.'}
                        </span>
                      </div>
                      ...
                      <FileControl field="programme_evenement" label="Programme / Contrat de salle (optionnel)" />

                      <div className="alert alert-info rounded-3 mt-2 d-flex gap-2 align-items-start" style={{ fontSize: '.85rem' }}>
                        <i className="fas fa-info-circle mt-1"></i>
                        <span>Les documents marqués <strong className="text-danger">*</strong> sont obligatoires. Les autres peuvent être apportés à la mairie si nécessaire.</span>
                      </div>
                    </div>
                    ...
                    <div className="d-grid gap-3">
                      <button type="submit" disabled={loading}
                        ...
                        {loading
                          ...
                          : <><i className="fas fa-paper-plane me-3"></i>Soumettre la déclaration</>}
                      </button>
