...
const TYPE_OPTIONS = [
  ...
  { value: 'politique',       label: '🏛️ Meeting politique' },
  { value: 'charite',         label: '❤️ Événement caritatif' },
...
const TYPE_ICON: Record<string, string> = {
  ...
  mariage:         'fa-ring',
  remise_diplomes: 'fa-graduation-cap',
  concert:         'fa-music',
  marche:          'fa-store',
