...
const translations: Record<Lang, Record<string, string>> = {
  fr: {
    ...
    baladi: 'Baladi (Municipal)',
    adli: 'Adli (Notaire)',
    municipality_hall: 'Salle de la Municipalité',
    private_place: 'Lieu Privé',
    adli_info_msg: 'Veuillez remettre vos documents aux Notaires (Adoul). Votre état civil sera mis à jour dans l\'application dès réception de l\'avis par la municipalité.',
  ...
  ar: {
    ...
    adli_info_msg: 'يرجى تسليم الوثائق لعدول الإشهاد، وسيتم تحديث حالتك المدنية في التطبيق فور وصول الإشعار من العدل إلى البلدية.',
